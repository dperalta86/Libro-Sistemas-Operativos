...
\begin{center}
\includegraphics[width=0.9\linewidth,keepaspectratio]{src/images/procesos/sequential.jpg}
...
\end{center}
<!-- 
![Diagrama de instrucciones secuenciales.](src/images/procesos/sequential.jpg){width=0.9\linewidth}
 -->
...
\begin{center}
\includegraphics[width=0.9\linewidth,keepaspectratio]{src/images/procesos/pipelined.jpg}
...
\end{center}
<!-- 
![Diagrama de ejecución pipeline, donde las etapas de una instrucción (fetch, decode, execute y writeback) se superponen en distintos ciclos de reloj para mejorar el rendimiento.](src/images/procesos/pipelined.jpg){width=0.9\linewidth}
 -->
...
\includegraphics[width=\linewidth,keepaspectratio]{src/images/procesos/layout-memoria.jpg}
\end{minipage}
\end{center}
\begin{warning}
